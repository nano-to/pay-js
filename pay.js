...
;(async () => {
	...
	if (window.NanoPay === undefined) window.NanoPay = { version: '2.0.11' }
    ...
    window.NanoPay.open = async (config) => {
		...
		cssContent += `
			@media (max-width: 480px) {
				...
				#nano-pay-body { top: 12px; right: 12px; bottom: auto; left: 12px; width: auto; max-height: calc(100% - 24px); overflow-y: auto; border-radius: 16px; box-shadow: 0 12px 40px rgba(0, 0, 0, 0.18); }
